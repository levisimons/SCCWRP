...
plot(networkgraphCon,vertex.label=NA,vertex.size=1,edge.width=-1*E(networkgraphCon)$weight, edge.color="red", normalized=TRUE,layout=layout.lgl(networkgraphCon))
dev.off()
#png(filename=paste(networkFile,"Nodes",networkNodecount,"Edges",networkEdgecount,"ConRandom.png",sep=""))
hist(degree(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm")),xlim=range(1:40),xlab="Node degree",ylim=range(1:20),main="",breaks=40)
#par(mar=c(0,0,0,0))
#plot(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm"),vertex.label=NA,vertex.size=degree(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm"),mode="total",loops=FALSE),edge.width=-1*E(networkgraphCon)$weight, edge.color="red", normalized=TRUE,layout=layout.lgl(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm")))
dev.off()
...
par(mar=c(0,0,0,0))
plot(networkgraphCov,vertex.label=NA,vertex.size=1,edge.width=1*E(networkgraphCov)$weight, edge.color="blue", normalized=TRUE,layout=layout.lgl(networkgraphCov))
dev.off()
#png(filename=paste(networkFile,"Nodes",networkNodecount,"Edges",networkEdgecount,"CovRandom.png",sep=""))
#par(mar=c(0,0,0,0))
#plot(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm"),vertex.label=NA,vertex.size=degree(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm"),mode="total",loops=FALSE),edge.width=1*E(networkgraphCov)$weight, edge.color="blue", normalized=TRUE,layout=layout.lgl(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm")))
hist(degree(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm")),xlim=range(1:40),xlab="Node degree",ylim=range(1:20),main="",breaks=40)
dev.off()
#hist(degree(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm")),xlab="Node degree",main="Degree distribution",breaks=max(degree(erdos.renyi.game(networkNodecount,networkEdgecount,type="gnm"))))
...
## Sample code for generating graphs to compare network parameters to mean land use.
dev.off()
plot(networkAnalysis$meanLU, networkAnalysis$l_con_rM, type='p', xlim=c(0.0,100.0), ylim=c(-2.5,0.5), xlab='Land Use % cover', ylab='Log-ratio modularity',main="Log-ratio modularity and land use",col="red")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$l_con_rM,df=3),col="red")
par(new=T)
plot(networkAnalysis$meanLU, networkAnalysis$l_cov_rM, type='p', xlim=c(0.0,100.0), ylim=c(-2.5,0.5), xlab='Land Use % cover', ylab='Log-ratio modularity',col="blue")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$l_cov_rM,df=3),col="blue")
par(new=F)
dev.off()
plot(networkAnalysis$meanLU, networkAnalysis$zeta_Con, type='p', xlim=c(0.0,100.0), ylim=c(1.0,2.5), xlab='Land Use % cover', ylab='Degree Heterogeneity',main="Degree Heterogeneity and land use",col="red")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$zeta_Con,df=3),col="red")
par(new=T)
plot(networkAnalysis$meanLU, networkAnalysis$zeta_Cov, type='p', xlim=c(0.0,100.0), ylim=c(1.0,2.5), xlab='Land Use % cover', ylab='Degree Heterogeneity',col="blue")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$zeta_Cov,df=3),col="blue")
par(new=F)
dev.off()
plot(networkAnalysis$meanLU, networkAnalysis$con_C, type='p', xlim=c(0.0,100.0), ylim=c(0.05,0.2), xlab='Land Use % cover', ylab='Connectance',main="Connectance and land use",col="red")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$con_C,df=3),col="red")
par(new=T)
plot(networkAnalysis$meanLU, networkAnalysis$cov_C, type='p', xlim=c(0.0,100.0), ylim=c(0.05,0.2), xlab='Land Use % cover', ylab='Connectance',col="blue")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$cov_C,df=3),col="blue")
par(new=F)
dev.off()
plot(networkAnalysis$meanLU, networkAnalysis$meanStrength_Con, type='p', xlim=c(0.0,100.0), ylim=c(0.0,0.045), xlab='Land Use % cover', ylab='Mean Correlation Strength',main="Mean Correlation Strength and land use",col="red")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$meanStrength_Con,df=3),col="red")
par(new=T)
plot(networkAnalysis$meanLU, networkAnalysis$meanStrength_Cov, type='p', xlim=c(0.0,100.0), ylim=c(0.0,0.045), xlab='Land Use % cover', ylab='Mean Correlation Strength',col="blue")
lines(smooth.spline(networkAnalysis$meanLU,networkAnalysis$meanStrength_Cov,df=3),col="blue")
par(new=F)
dev.off()
plot(networkAnalysis$meanLU, -1*networkAnalysis$lambda_network_m_Con, type='p', xlim=c(0.0,100.0), ylim=c(-6.5,-0.7), xlab='Land Use % cover', ylab='Resilience',main="Resilience and land use",col="red")
lines(smooth.spline(networkAnalysis$meanLU,-1*networkAnalysis$lambda_network_m_Con,df=3),col="red")
par(new=T)
plot(networkAnalysis$meanLU, -1*networkAnalysis$lambda_network_m_Cov, type='p', xlim=c(0.0,100.0), ylim=c(-6.5,-0.7), xlab='Land Use % cover', ylab='Resilience',col="blue")
...
chart.Correlation(networkAnalysis[,c("meanLU","con_C","Network_size")], histogram=FALSE, method="spearman")
chart.Correlation(networkAnalysis[,c("meanLU","cov_C","Network_size")], histogram=FALSE, method="spearman")
...
chart.Correlation(networkAnalysis[,c("meanLU","meanStrength_Con","zeta_Con","lambda_network_m_Con","l_con_rM","con_C")], histogram=FALSE, method="spearman")
chart.Correlation(networkAnalysis[,c("meanLU","meanStrength_Cov","zeta_Cov","lambda_network_m_Cov","l_cov_rM","cov_C")], histogram=FALSE, method="spearman")
