...
communityInput <- communityInput[, -which(names(communityInput)  %in% c("ConsensusLineage.y","ConsensusLineage.x","EFE"))]
...
corrplot(zetaCor, type="upper", tl.col="black", tl.srt=45, tl.cex=1.3, order="original", sig.level=0.05, insig="blank", title=paste("rbcL",communityType,"\n aggregated to",taxonomicLevel),mar=c(0,0,3,0))
